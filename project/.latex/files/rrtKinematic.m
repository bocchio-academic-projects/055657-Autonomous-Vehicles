...
%       NODE_INITIAL  - Starting node with state [x, y, theta].
%       NODE_FINAL    - Goal node with target state [x, y, theta].
...
%   to ensure that the generated paths respect the system kinematic constraints.
